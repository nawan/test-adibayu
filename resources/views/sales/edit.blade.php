                ...
                <form action="{{ route('sales.update', $sale->id) }}" method="POST" id="saleForm">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="code" value="{{ $sale->code }}" readonly>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 offset-md-6">
                            <div class="card bg-light">
                                <div class="card-body">
                                    <h5>Total Keseluruhan: <span id="grandTotal">Rp {{ number_format($sale->total_amount, 0, ',', '.') }}</span></h5>
                                </div>
                            </div>
                        </div>
                    </div>
